...
def _install_stubs() -> Any:
    ...
    **The stubs go in before the import**, because the generating method imports
    ...
    """
    _stub_windows_only("runners.hi3dgen")
    ...
    pipeline = types.ModuleType("runners.hi3dgen.pipeline")
    ...
    sys.modules["runners.hi3dgen.pipeline"] = pipeline

    from runners.hi3dgen import __main__ as runner
